...
import com.jayalaga.advancemobiletask.presentation.screen.login.component.EmailTextField
import com.jayalaga.advancemobiletask.presentation.screen.login.component.GoogleButton
import com.jayalaga.advancemobiletask.presentation.screen.login.component.PasswordTextField
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        LoginContent(
            ...
            moveToForgot = {
                Toast.makeText(
                    context,
                    "Still In progress or just tampilan doang!!",
                    Toast.LENGTH_SHORT
                ).show()
            },
            onGoogleClick = {
